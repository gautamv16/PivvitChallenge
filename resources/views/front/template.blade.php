...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li {!! classActivePath('/') !!}>
							{!! link_to('/purchase/create', 'Create Purchase') !!}
						</li>
						<li {!! classActivePath('/') !!}>
							{!! link_to('/purchase/list', 'Purchase List') !!}
						</li>
	...
	<footer role="contentinfo">
		 @yield('footer')
		<p class="text-center"><small>Copyright &copy; Gautam <a href="http://yooshopper.com">www.yooshopper.com</a></small></p>
	</footer>
